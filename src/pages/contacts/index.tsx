        ...
        <div className="w-1/2 shadow-xl p-3 px-4 flex flex-col gap-2 md:w-full">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className=" flex flex-col gap-1">
              <span className="!text-md">Исанова 42, помещение 11,  2 этаж </span>
              <span className="text-gray-500 text-sm">
              Добро пожаловать в стоматологическую клинику Dr.Noorlan,
               где мы предоставляем полный спектр стоматологических услуг: 
               от лечения и протезирования до имплантации и многого другого. 
               Наши квалифицированные врачи, снабженные современным оборудованием, 
               гарантируют высокое качество лечения. Запишитесь на прием онлайн и 
               доверьте заботу о вашей улыбке нам.
              </span>
            </p>
          </div>
          <br />
